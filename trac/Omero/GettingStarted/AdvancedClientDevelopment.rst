...
`OmeroApi </ome/wiki/OmeroApi>`_ to talk to the
`OmeroBlitz </ome/wiki/OmeroBlitz>`_ server in any of the supported
languages, like `Python </ome/wiki/OmeroPy>`_,
`C++ </ome/wiki/OmeroCpp>`_, `Java </ome/wiki/OmeroJava>`_, or
`Matlab </ome/wiki/OmeroMatlab>`_. A general understanding of the
...
method calls available in the `OmeroApi </ome/wiki/OmeroApi>`_), it's
...
-  **Sequences.** & **Dictionaries** : Most of the sequences and
   dictionaries in use by the `OmeroApi </ome/wiki/OmeroApi>`_ are
   defined in
...
-  **Constants.** : Most of the enumerations for
   `OmeroApi </ome/wiki/OmeroApi>`_ are defined in
...
-  **Enums.** Finally, enumerations which are less used through
   `OmeroApi </ome/wiki/OmeroApi>`_, but which can be useful for
...
The original `OmeroApi </ome/wiki/OmeroApi>`_ was designed strictly for
...
Like smart pointers for `OmeroCpp </ome/wiki/OmeroCpp>`_, the
...
The first step in accessing the `OmeroApi </ome/wiki/OmeroApi>`_ and
...
`OmeroApi </ome/wiki/OmeroApi>`_ (for Application Programming
Interface). Each service is defined in a slice file under
...
that much of the code for `OmeroPy </ome/wiki/OmeroPy>`_,
`OmeroCpp </ome/wiki/OmeroCpp>`_, and `OmeroJava </ome/wiki/OmeroJava>`_
