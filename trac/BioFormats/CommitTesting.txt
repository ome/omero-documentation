...
` http://github/openmicroscopy/bioformats <http://github/openmicroscopy/bioformats>`_,
...
`WorkingWithOmero/UsingGit </ome/wiki/WorkingWithOmero/UsingGit>`_
...
loci-software-test-$DATE.log.

If Ant reports that the build was successful, then there is nothing that
you need to do. Otherwise, it's helpful if you can provide the command,
