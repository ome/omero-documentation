...
` here <http://www.loci.wisc.edu/bio-formats/matlab>`_.
...
In the near future, we will have a script for saving files similar to
bfopen.m; see ticket `#4112 </ome/ticket/4112>`_ for details.
