...
-  OME:Dataset(base = ``None``, type = ``Dataset``)
   ...
   -  OME:Dataset:Name( ``xsd:string`` ) [0:1]
...
-  OME:ImagingEnvironment(base = ``None``, type =
   ...
   -  OME:ImagingEnvironment:Temperature( ``xsd:float`` ) [0:1]
...
-  OME:PlaneTiming(base = ``None``, type = ``PlaneTiming``)

   -  OME:PlaneTiming:ExposureTime( ``xsd:float`` ) [0:1]
   -  OME:PlaneTiming:DeltaT( ``xsd:float`` ) [0:1]
...
-  OME:ManufactSpec(base = ``None``, type = ``ManufactSpec``)

   -  OME:ManufactSpec:Model( ``xsd:string`` ) [0:1]
   -  OME:ManufactSpec:SerialNumber( ``xsd:string`` ) [0:1]
   -  OME:ManufactSpec:Manufacturer( ``xsd:string`` ) [0:1]
...
-  OME:Image(base = ``None``, type = ``Image``)
   ...
   -  OME:Image:CreationDate( ``xsd:dateTime`` ) [0:1]
   -  OME:Image:DisplayOptions( ``DisplayOptions`` ) [0:1]

OME:Pixels
~~~~~~~~~~

-  OME:Pixels(base = ``None``, type = ``Pixels``)

   -  OME:Pixels:SizeT( ``xsd:positiveInteger`` ) [1:1]
   -  OME:Pixels:DimensionOrder( ``xsd:string`` ) [1:1]
   -  OME:Pixels:TimeIncrement( ``xsd:float`` ) [0:1]
   -  OME:Pixels:PhysicalSizeY( ``xsd:float`` ) [0:1]
   -  OME:Pixels:PhysicalSizeX( ``xsd:float`` ) [0:1]
   -  OME:Pixels:PhysicalSizeZ( ``xsd:float`` ) [0:1]
   -  OME:Pixels:SizeX( ``xsd:positiveInteger`` ) [1:1]
   -  OME:Pixels:SizeY( ``xsd:positiveInteger`` ) [1:1]
   -  OME:Pixels:SizeZ( ``xsd:positiveInteger`` ) [1:1]
   -  OME:Pixels:TiffData( ``TiffData`` ) [1:1]
   -  OME:Pixels:WaveStart( ``xsd:positiveInteger`` ) [0:1]
   -  OME:Pixels:BigEndian( ``xsd:boolean`` ) [1:1]
   -  OME:Pixels:Plane( ``Plane`` ) [0:99999]
   -  OME:Pixels:BinData( ``xsd:string`` ) [1:1]
   -  OME:Pixels:PixelType( ``PixelTypes`` ) [1:1]
   -  OME:Pixels:WaveIncrement( ``xsd:positiveInteger`` ) [0:1]
   -  OME:Pixels:ID( ``PixelsID`` ) [1:1]
   -  OME:Pixels:SizeC( ``xsd:positiveInteger`` ) [1:1]
...
-  OME:LightSource(base = ``ManufactSpec``, type = ``LightSource``)
   ...
   -  OME:LightSource:LightEmittingDiode( ``LightEmittingDiode`` ) [1:1]
...
-  OME:DetectorRef(base = ``Reference``, type = ``DetectorRef``)

   -  OME:DetectorRef:Gain( ``xsd:float`` ) [0:1]
   -  OME:DetectorRef:Binning( ``Binning`` ) [0:1]
   -  OME:DetectorRef:Voltage( ``xsd:float`` ) [0:1]
   -  OME:DetectorRef:Offset( ``xsd:float`` ) [0:1]
...
-  OME:Objective(base = ``ManufactSpec``, type = ``Objective``)

   -  OME:Objective:WorkingDistance( ``xsd:float`` ) [0:1]
   -  OME:Objective:Immersion( ``xsd:string`` ) [1:1]
   ...
   -  OME:Objective:LensNA( ``xsd:float`` ) [0:1]
   -  OME:Objective:NominalMagnification( ``xsd:integer`` ) [0:1]
   -  OME:Objective:CalibratedMagnification( ``xsd:float`` ) [0:1]
...
-  OME:Filter(base = ``FilterSpec``, type = ``Filter``)
   ...
   -  OME:Filter:TransmittanceRange( ``TransmittanceRange`` ) [0:1]
...
-  OME:Plane(base = ``None``, type = ``Plane``)

   -  OME:Plane:TheC( ``xsd:integer`` ) [1:1]
   -  OME:Plane:HashSHA1( ``xsd:string`` ) [1:1]
   -  OME:Plane:TheZ( ``xsd:integer`` ) [1:1]
   -  OME:Plane:PlaneTiming( ``PlaneTiming`` ) [0:1]
   -  OME:Plane:TheT( ``xsd:integer`` ) [1:1]
...
-  OME:Instrument(base = ``None``, type = ``Instrument``)
   ...
   -  OME:Instrument:Microscope( ``Microscope`` ) [0:1]
...
-  OME:StagePosition(base = ``None``, type = ``StagePosition``)

   -  OME:StagePosition:PositionZ( ``xsd:float`` ) [0:1]
   -  OME:StagePosition:PositionX( ``xsd:float`` ) [0:1]
   -  OME:StagePosition:PositionY( ``xsd:float`` ) [0:1]
...
-  OME:Detector(base = ``ManufactSpec``, type = ``Detector``)

   -  OME:Detector:Zoom( ``xsd:float`` ) [0:1]
   -  OME:Detector:AmplificationGain( ``xsd:float`` ) [0:1]
   -  OME:Detector:Gain( ``xsd:float`` ) [0:1]
   -  OME:Detector:Offset( ``xsd:float`` ) [0:1]
   -  OME:Detector:LogicalChannel\_BackReference( ``LogicalChannel`` )
      [0:9999]
   -  OME:Detector:Type( ``xsd:string`` ) [1:1]
   -  OME:Detector:ID( ``DetectorID`` ) [1:1]
   -  OME:Detector:Voltage( ``xsd:float`` ) [0:1]
...
-  OME:LogicalChannel(base = ``None``, type = ``LogicalChannel``)
   ...
   -  OME:LogicalChannel:SamplesPerPixel( ``xsd:integer`` ) [0:1]
   -  OME:LogicalChannel:ContrastMethod( ``xsd:string`` ) [0:1]
   -  OME:LogicalChannel:FilterSetRef( ``FilterSetRef`` ) [0:1]
   -  OME:LogicalChannel:SecondaryEmissionFilter( ``FilterID`` ) [0:1]
   -  OME:LogicalChannel:ID( ``LogicalChannelID`` ) [1:1]
   -  OME:LogicalChannel:Channels\_BackReference( ``Channels`` )
      [0:9999]
   -  OME:LogicalChannel:Fluor( ``xsd:string`` ) [0:1]
   -  OME:LogicalChannel:PinholeSize( ``xsd:float`` ) [0:1]
   -  OME:LogicalChannel:NdFilter( ``xsd:float`` ) [0:1]
   -  OME:LogicalChannel:Mode( ``xsd:string`` ) [0:1]
   -  OME:LogicalChannel:DetectorRef( ``DetectorRef`` ) [0:1]
   -  OME:LogicalChannel:OTFRef( ``OTFRef`` ) [0:1]
   -  OME:LogicalChannel:EmWave( ``xsd:positiveInteger`` ) [0:1]
   -  OME:LogicalChannel:ExWave( ``xsd:positiveInteger`` ) [0:1]
   -  OME:LogicalChannel:LightSourceRef( ``LightSourceRef`` ) [0:1]
   -  OME:LogicalChannel:IlluminationType( ``xsd:string`` ) [0:1]
   -  OME:LogicalChannel:Name( ``xsd:string`` ) [0:1]
...
-  OME:Experimenter(base = ``None``, type = ``Experimenter``)

   -  OME:Experimenter:Email( ``xsd:string`` ) [1:1]
   -  OME:Experimenter:OMEName( ``xsd:string`` ) [1:1]
   -  OME:Experimenter:FirstName( ``xsd:string`` ) [1:1]
   -  OME:Experimenter:LastName( ``xsd:string`` ) [1:1]
   -  OME:Experimenter:Image\_BackReference( ``Image`` ) [0:9999]
   -  OME:Experimenter:GroupRef( ``GroupRef`` ) [0:99999]
   -  OME:Experimenter:ID( ``ExperimenterID`` ) [1:1]
   ...
   -  OME:Experimenter:Institution( ``xsd:string`` ) [0:1]
...
-  OME:DisplayOptions(base = ``None``, type = ``DisplayOptions``)
   ...
   -  OME:DisplayOptions:Zoom( ``xsd:float`` ) [0:1]
   ...
   -  OME:DisplayOptions:ID( ``DisplayOptionsID`` ) [1:1]
...
-  SPW:Well(base = ``None``, type = ``Well``)

   -  SPW:Well:ExternalIdentifier( ``xsd:string`` ) [0:1]
   -  SPW:Well:Column( ``xsd:integer`` ) [0:1]
...
-  SPW:Screen(base = ``None``, type = ``Screen``)
   ...
   -  SPW:Screen:Name( ``xsd:string`` ) [0:1]
...
-  SPW:Plate(base = ``None``, type = ``Plate``)

   -  SPW:Plate:Status( ``xsd:string`` ) [0:1]
   -  SPW:Plate:Name( ``xsd:string`` ) [0:1]
...
-  SPW:WellSample(base = ``None``, type = ``WellSample``)

   -  SPW:WellSample:Index( ``xsd:integer`` ) [0:1]
...
**\* Error. attributeGroup CLI:InputLocation not defined.**\ \* Error.
attributeGroup CLI:InputLocation not defined. **\* Error. attributeGroup
CLI:InputLocation not defined.**\ \* Error. attributeGroup
CLI:InputLocation not defined. **\* Error. attributeGroup
CLI:OutputLocation not defined.**\ \* Error. attributeGroup
CLI:InputLocation not defined.
...
-  SA:XmlAnnotation(base = ``CommonAnnotation``, type =
   ``XmlAnnotation``)

   -  SA:XmlAnnotation:Value( ``xsd:string`` ) [1:1]
...
-  SA:StructuredAnnotations(base = ``None``, type =
   ...
   -  SA:StructuredAnnotations:LongAnnotation( ``LongAnnotation`` )
      [1:1]
   -  SA:StructuredAnnotations:StringAnnotation( ``StringAnnotation`` )
      [1:1]
   -  SA:StructuredAnnotations:DoubleAnnotation( ``DoubleAnnotation`` )
      [1:1]
   -  SA:StructuredAnnotations:XmlAnnotation( ``XmlAnnotation`` ) [1:1]
...
-  SA:StringAnnotation(base = ``CommonAnnotation``, type =
   ``StringAnnotation``)

   -  SA:StringAnnotation:Value( ``xsd:string`` ) [1:1]
