...
:guide:`Administrate Users OMERO Guide  <introduction/docs/group-user-management.html>`.
...
- OMERO.web: allows viewing and downloading the data,
  see :guide:`Viewing Data <web_addons.html>` and :guide:`Downloading Data <download/docs/download.html>`.
...
- OMERO.web: all the Data Organizing actions are possible, except transfer
  ...
  see :guide:`Data management guide <introduction/docs/data-management.html>`.
