...
:doc:`install-web/walkthrough/omeroweb-install-ubuntu1604-ice3.6` or
to deploy with OMERO.server :doc:`install-web/walkthrough/omeroweb-install-with-server-ubuntu1604-ice3.6`
