...
print('version_blitz = "5.5.8"')
print('version_server = "5.6.1"')
print('version_romio = "5.6.2"')
print('version_renderer = "5.5.7"')
print('version_common = "5.5.7"')
print('version_model = "5.6.2"')
print('version_gateway = "5.6.5"')
print('version_insight = "5.5.14"')
print('version_matlab = "5.5.3"')
print('version_dsl_plugin = "5.5.0"')
print('version_blitz_plugin = "5.5.0"')
print('version_ice_builder = "1.5.0"')
print('version_py = "5.8.1"')
print('version_web = "5.8.1"')
