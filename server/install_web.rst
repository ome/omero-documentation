...
If you need help configuring your firewall rules, see the :ref:`server/security` page.

Prerequisites
-------------

-  OMERO 4.4.1 and its prerequisites (see :ref:`Unix <server/installation>`
   or :ref:`Windows <server/install-windows>` installation page).
